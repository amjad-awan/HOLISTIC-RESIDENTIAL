          ...
          <div className="flex justify-between mt-[30px]  ">
            <ul className=" list-disc ">
              <li className="mb-[5px] text-[18px] font-[400] text-[#fff]">Medical insurance</li>
               <li className="mb-[5px] text-[18px] font-[400] text-[#fff]">Dental insurance</li>
               <li className="mb-[5px] text-[18px] font-[400] text-[#fff]">Vision insurance</li>
               <li className="mb-[5px] text-[18px] font-[400] text-[#fff]">Life insurance</li>
               <li className="mb-[5px] text-[18px] font-[400] text-[#fff]">Disability insurance</li>
            </ul>

            <ul className="list-disc">
               <li className="mb-[5px] text-[18px] font-[400] text-[#fff]">Vacation and sick days</li>
               <li className="mb-[5px] text-[18px] font-[400] text-[#fff]">Tuition reimbursement</li>
               <li className="mb-[5px] text-[18px] font-[400] text-[#fff]">Employee retirement savings</li>
               <li className="mb-[5px] text-[18px] font-[400] text-[#fff]">Flexible spending accounts</li>
               <li className="mb-[5px] text-[18px] font-[400] text-[#fff]">Employee assistance program</li>
            </ul>
          </div>
        </div>
      </div>
